namespace SrvSurvey
{
    partial class FormRuins
    {
        ...
        private void InitializeComponent()
        {
            ...
            comboSite = new ThemedComboBox();
            label4 = new Label();
            comboSiteType = new ThemedComboBox();
            panel1 = new Panel();
            ...
            label2 = new Label();
            label1 = new Label();
            numA = new ThemedNumericUpDown();
            button1 = new FlatButton();
            numScale = new ThemedNumericUpDown();
