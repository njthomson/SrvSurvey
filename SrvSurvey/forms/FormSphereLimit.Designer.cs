namespace SrvSurvey
{
    partial class FormSphereLimit
    {
        ...
        private void InitializeComponent()
        {
            ...
            txtStarPos = new ThemedTextBox();
            label3 = new Label();
            numRadius = new ThemedNumericUpDown();
            ...
            txtCurrentDistance = new ThemedTextBox();
        ...
        private ThemedTextBox txtStarPos;
        private Label label3;
        private ThemedNumericUpDown numRadius;
        ...
        private ThemedTextBox txtCurrentDistance;
